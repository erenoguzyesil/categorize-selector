...
let a={};for(let b of Object.keys(TokenType))a[this._prettifyTokenType(b)]=[];for(let b of this._tokens)a[Object.keys(a)[b.type]].push(b.lexeme);return a}}function categorizeSelector(a){return(new Scanner(a)).categorize()}